...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . tep_image(DIR_WS_CATALOG_IMAGES . 'LHT_Logo.jpg', 'osCommerce Online Merchant v' . tep_get_version(), '', '', 'style="width: 100px;"') . '</a>'; ?></td>
  </tr>
  <tr class="headerBar">
