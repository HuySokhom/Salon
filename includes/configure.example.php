...
define('HTTP_COOKIE_PATH', '/Salon/');
define('HTTPS_COOKIE_PATH', '/Salon/');
define('DIR_WS_HTTP_CATALOG', '/Salon/');
define('DIR_WS_HTTPS_CATALOG', '/Salon/');
...
define('DIR_FS_CATALOG', 'C:wamp\www\Salon/');
